...
python tools/lazyconfig_train_net_kfold_test.py --config-file configs/Misc/torchvision_imagenet_R_50.py \
...
"""
Note: Here we put reusable code (models, 1, data) together with configs just as a
