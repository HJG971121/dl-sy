...
class DensePoseCOCOEvaluator(DatasetEvaluator):
    def __init__(
        ...
        ), "Mesh alignment 1 is activated, but no vertex embedder provided!"
    ...
    def _evaluate_mesh_alignment(self):
        self._logger.info("Mesh alignment 1 ...")
...
def prediction_to_dict(instances, img_id, embedder, class_to_mesh_name, use_storage):
    ...
    Returns:
        list[dict]: the results in densepose 1 format
    """
...
def _derive_results_from_coco_eval(
    ...
    # (see detectron2/1/coco_evaluation.py):
