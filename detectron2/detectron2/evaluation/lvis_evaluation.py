    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            distributed (True): if True, will collect results from all ranks for 1.
        ...
        # performed using the LVIS 1 server).
...
def _evaluate_box_proposals(dataset_predictions, lvis_api, thresholds=None, area="all", limit=None):
    ...
    faster alternative to the official LVIS API recall 1 code. However,
