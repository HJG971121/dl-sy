...
from detectron2.projects.segmentation.data.build_light import build_kfold_loader
...
class DataloaderReset(HookBase):
    def __init__(self, reset_period, dataloader):
        self._period = reset_period
