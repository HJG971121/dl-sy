...
from detectron2.projects.segmentation.transforms import FlipTransform, RandomCrop, RandomSizeCrop, RandomCBTransform, RotateTransform
...
from ..modeling.head_unet import MTTGnrtUNetHead
...
# 'baseline_UNet_240324_MSE+vMSE_FullTransform_D3Picked\model_0016799.pth'
INIT_CHECKPOINT = ''
INIT_CHECKPOINT = 'E:\dl-sy\GenerativeMTT\\results\\baseline_UNet_240602_MSE+vMSE_MS_30\model_0047599.pth'
...
# ANNO_FILE_TRAIN = 'E:\Generative_MTT\data\jsons\GenerativeMTT_picked_LSI_MS_train.json'
# ANNO_FILE_VALID = 'E:\Generative_MTT\data\jsons\GenerativeMTT_picked_LSI_MS_valid.json'
...
ANNO_FILE_VALID = 'E:\Generative_MTT\data\jsons\GenerativeMTT_S15_LSI_MS_30_valid.json'


# ANNO_FILE_VALID = 'E:\Generative_MTT\data\jsons\GenerativeMTT_picked_LSI_test_LSI_valid.json'
...
model = L(MTTGenerator)(
        ...
        head = L(MTTGnrtUNetHead)(
            loss_function = LOSS_FUNCTION,
            in_channels = FEATS[0:1]+FEATS[:-1],
