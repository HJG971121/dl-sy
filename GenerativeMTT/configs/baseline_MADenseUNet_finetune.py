...
from detectron2.projects.segmentation.transforms import FlipTransform, RandomSizeCrop, RandomCBTransform, RotateTransform
...
INIT_CHECKPOINT = 'E:\dl-sy\GenerativeMTT\\results\\' \
                  'baseline_MADenseUNet_231229_MSE+vMSE_RandomSizeCrop_PickedData_ds2_1\model_0029999.pth'

ANNO_FILE_TRAIN = 'E:\Generative_MTT\data\jsons\GenerativeMTT_picked_LSI_train.json'
ANNO_FILE_VALID = 'E:\Generative_MTT\data\jsons\GenerativeMTT_full_LSI_valid.json'
