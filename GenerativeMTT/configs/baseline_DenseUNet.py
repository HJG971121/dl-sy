...
from detectron2.projects.segmentation.data import (BaseDataset,
                                                   build_train_loader,
                                                   build_test_loader)
from detectron2.projects.segmentation.modeling import DenseUNetBackbone
...
from ..common.losses import (LossList, MSEloss, vMSEloss, L1loss, vL1loss, VGGloss)
...
# 'baseline_DenseUNet_240301_MSE+vMSE_FullTransformbutCB_D3Picked_ds2_1\model_0016799.pth'


INIT_CHECKPOINT = ''
INIT_CHECKPOINT = 'E:\dl-sy\GenerativeMTT\\results\\baseline_DenseUNet_240601_MSE+vMSE_ds2_1_MS_30\model_0041999.pth'
...
GROWTH_RATE = [x for x in [8, 16, 32, 64, 128]]
BLOCKS = [2, 4, 5, 6, 6]
DEEP_SUPERVISION = 2
